...
public class Bank {
    ...
    /**
     * Instantiates a new bank, it does so by loading the accounts and setting
     * owners to the various accounts.
     */
    public Bank() {
        // loadAccounts();
        // setAccountOwners();
    ...
    /**
     * This method will search through the account list for a corresponding
     * account ID and then return the account
     *
    ...
    public ArrayList<String> getAccountListbyOwner(String customerID) {
        ArrayList<String> accounts = new ArrayList<String>();
        String sql = "SELECT fk_accountID FROM customer_account WHERE fk_customerID='" + customerID + "' ;";
        ...
        try {
            ...
            while (rs.next()) {
                ...
                // accounts.add(newAccount.getAccountID());
                accounts.add(rs.getString("fk_accountID"));
    ...
    /**
     * This method will search through the customer list for a corresponding
     * customer id then return the customer
     *
    ...
    /**
     * This method loads the customer and their accounts. It then adds them to
     * two array lists in order to assign who owns what account.
     *
     */
    ...
    /**
     * This method loads all of the accounts in the database and places them in
     * an array list
     */
